...
if __name__ == '__main__':
    ...
    problem = JointSegmentationInsertionProblem(wordsegUtil.removeAll("stff", 'aeiou'), smoothCost, possibleFills)
#    problem = JointSegmentationInsertionProblem('whatsup', smoothCost, possibleFills)
